//DESAFIO NÍVEL AVENTUREIRO - FREEFIRE
//Buscar por item no inventario da mochila 
...
int main() {
    ...
    do {
        ...
        //le como string e converte para inteiro assim evita o bug do scanf
        fgets(entrada, sizeof(entrada), stdin);
        opcao = atoi(entrada); //converte o texto para número
